 ...
 * @author Welcome
 */
@WebServlet(name = "UpdatePriceCartServlet", urlPatterns = {"/UpdatePriceCartServlet"})
        ...
        try {
            ...
            if (role.equals("USER")) {
                ...
                for (int i = 0; i < cart.getCart().size(); i++) {
                    cart.changeQuantitybyID(productIDArray[i], Integer.parseInt(quantityArray[i]));
                }
            ...
            log("Error at UpdatePriceCartServlet: " + e.getMessage());
        } finally {
