    ...
    <body>
        ...
        <div class="container-fulid">
            <form action="DispatchServlet">
                ...
                Price:<br/>
                <input type="number" name="txtPrice" value="${product.price}" required="" style="width: 84%" min="1"/><br/>
                Category: <br/>
                ...
                Quantity:<br/>
                <input type="number" name="txtQuantity" value="${product.quantity}" required=""  style="width: 84%" min="0"/><br/>
                <br/>
