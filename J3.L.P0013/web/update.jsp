...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha90-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl" crossorigin="anonymous">
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js" integrity="sha90-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0" crossorigin="anonymous"></script>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="container-fulid" style="margin-left: 5%;">
            <form action="DispatchServlet">
                <c:forEach var="product" items="${UPDATEPRODUCT}">
                    <input type="hidden" name="txtProductID" value="${product.productID}" required="" style="width:90%"/><br/>
                    Product Name:<br/>
                    ...
                    Price:<br/>
                    <input type="number" name="txtPrice" value="${product.price}" min="1" required="" style="width:90%"/><br/>
                    Create Date: <br/>
                    <input type="date" name="txtCreateDate" value="${product.createDate}" required="" style="width:90%"/><br/>
                    Category:<br/>
                    ...
                    Quantity:<br/>
                    <input type="number" name="txtQuantity" value="${product.quantity}" min="0" required=""  style="width:90%"/><br/>
                    <br/>
